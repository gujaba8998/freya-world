...
function Header({ onOpenGate, onOpenSheet, onOpenAvatar }) {
  const { stars, level, levelInto, dark, setDark, soundOn, setSoundOn, musicOn, setMusicOn, musicTrack, setMusicTrack, beep, settings, profile, parentMode, setParentMode, fbStatus } = useApp();
